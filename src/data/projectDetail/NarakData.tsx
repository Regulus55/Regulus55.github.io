...
export const NarakData: ProjectDetail = {
  slug: "narak",
  title: "Narak - 나락",
  ...
  preview: [
    ...
    },
    {
      ...
      content: [
        "주식의 현재가, 등락폭, 가격 추이 등을 시각적으로 확인할 수 있는 상세 정보 페이지",
      ],
    },
    {
      title: "환율정보창",
      ...
      content: [
        "타 주식 사이트에서 해외 주식 거래 시 현재 환율을 빠르게 볼 수 있는 방법이 없어 불편함을 느꼈고, 주식 상세 페이지에서 바로 환율을 확인 할 수 있도록 만들었습니다",
        "(현재 환율은 목데이터 입니다)",
      ],
    },
  ],
