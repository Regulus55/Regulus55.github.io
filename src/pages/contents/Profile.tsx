...
const Profile = () => {
  return (
    <div className="relative flex flex-col items-center lg:items-start justify-center w-full h-full max-w-7xl p-10 rounded-3xl mt-52 mb-40">
      <div className="items-start">
      <ContentsTitle className="ml-3 sm:ml-6 mb-6">PROFILE</ContentsTitle>
      <Glassmorphism className={`relative flex flex-col  items-center justify-start w-auto px-10 py-6
                                sm:px-20 sm:py-10
                                 lg:flex-row lg:pl-6 lg:pr-60 lg:px-0 lg:py-10
        `}>
        <div className={`flex items-left bg-white rounded-full border mb-10
                         lg:ml-10 lg:mr-20 lg:mb-0
          `}>
          <img
            src="/images/regulus.webp"
            alt=""
            className={`h-52 w-52 rounded-full p-4
                        xl:h-60 xl:w-60
              `}
          />
        </div>
